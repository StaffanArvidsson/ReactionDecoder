...
public final class FragmentFilter extends Sotter implements IChemicalFilter<Integer> {
    ...
    private synchronized int getMappedMoleculeFragmentSize(AtomAtomMapping mcsAtomSolution) {
        ...
        IAtomContainer Educt = GlobalSettings.BUILDER.newInstance(IAtomContainer.class, chemfilter.getQuery());
        IAtomContainer product = GlobalSettings.BUILDER.newInstance(IAtomContainer.class, chemfilter.getTarget());
    ...
    private synchronized int getFragmentCount(IAtomContainer molecule) {
        ...
        IAtomContainerSet fragmentMolSet = GlobalSettings.BUILDER.newInstance(IAtomContainerSet.class);
        int countFrag = 0;
